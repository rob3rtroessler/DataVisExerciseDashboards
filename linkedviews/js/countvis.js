...
CountVis.prototype.initVis = function () {
    ...
    vis.brush = d3.brushX()
        ...
        .on("brush", function (event) {
            vis.currentBrushRegion = event.selection.map(vis.x.invert);
...
CountVis.prototype.updateVis = function () {
    ...
    if (vis.zoomActive)
        document.getElementById('reset-zoom').display = "block";
    else
        document.getElementById('reset-zoom').display = "none";
